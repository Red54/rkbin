...
## rk3506_tee_v2.40.bin

| Date       | File                 | Build commit | Severity  |
| ---------- | :------------------- | ------------ | --------- |
| 2025-12-11 | rk3506_tee_v2.40.bin | b204648dc    | important |

### New

1. Enable internal_npor_reset_en.

------

## rk3506_spl_v1.12.bin

| Date       | File                 | Build commit | Severity  |
| ---------- | :------------------- | ------------ | --------- |
| 2025-10-22 | rk3506_spl_v1.12.bin | 80d18cf0259  | important |

### New

1. Set boot device iomux when init and detect it.
