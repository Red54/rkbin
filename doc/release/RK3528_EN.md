...
| ---------- | --------------------- | ------------ | --------- |
| 2025-11-26 | rk3528_bl31_v1.21.elf | 8b08e7182    | important |

### New

1. Add support for WDQS features for LP4 and LP4X. This feature can only be supported when used in conjunction with `specific/rk3528/rk3528_ddr_1056MHz_wdqs*.bin`.
