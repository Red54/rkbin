...
| ---------- | :-------------------- | ------------ | --------- |
| 2025-12-31 | rk3576_busmcu_uart8_v1.04.bin | rt-thread:785be4000c#hal:b7904829 | moderate |

### Fixed

| Index | Severity  | Update                                  | Issue description                   | Issue source |
| ----- | --------- | --------------------------------------- | ----------------------------------- | ------------ |
| 1     | moderate  | Fix GPIO interrupt loss in MOS System. | linux loss GPIO interrupt            | -            |

------

## rk3576_bl31__{_primary,secondary}_v1.12.elf

| Date       | File                                        | Build commit | Severity  |
| ---------- | :------------------------------------------ | ------------ | --------- |
| 2025-12-30 | rk3576_bl31__{_primary,secondary}_v1.12.elf | 8c38b08c8    | important |

### New

1. Support basic system suspend functions.
...
| Date       | File                  | Build commit | Severity  |
| ---------- | :-------------------- | ------------ | --------- |
| 2025-12-26 | rk3576_bl31_v1.24.elf | 1430f6b09 | important |

### New

1. Support to configure bus_mcu cache.
...
| Date       | File                         | Build commit | Severity  |
| ---------- | :--------------------------- | ------------ | --------- |
| 2025-12-22 | rk3576_usbplug_mos_v1.07.bin | 051db4f86bd  | important |

### Fixed

| Index | Severity  | Update                                  | Issue description                   | Issue source |
| ----- | --------- | --------------------------------------- | ----------------------------------- | ------------ |
| 1     | important | Fix flash images failed in maskrom mode | flash images failed in maskrom mode | -            |
...
| Date       | File                                                         | Build commit | Severity  |
| ---------- | :----------------------------------------------------------- | ------------ | --------- |
| 2025-12-03 | rk3576_ddr_lp4_2112MHz_lp5_2736MHz{_ultra,_eyescan,_mos,_ultra_mos}_v1.12.bin | ef40306b8f   | important |

### New

1. Support using the tool to enable or disable ZQ related checks.
2. Support using the tool to configure tRFC.
3. Support pstore (default is off).
...
| 2     | important | Optimize the MR configuration process during LP4(X) initialization | Prevent insufficient LP4(X) CA signal margin during the initialization | -              |
| 3     | important | After configuring the serial port clock, increase the delay        | Prevent serial port instability                               | -        |
...
| Date       | File                  | Build commit | Severity  |
| ---------- | :-------------------- | ------------ | --------- |
| 2025-11-26 | rk3576_bl31_v1.23.elf | f7dd574b4 | important |

### New

1. Optimize the speed of booting the big cores after system resume.
...
| Date       | File                  | Build commit | Severity  |
| ---------- | :-------------------- | ------------ | --------- |
| 2025-11-07 | rk3576_bl32_v1.08.bin | 500b55c8a    | important |

### Fixed

| Index | Severity  | Update                                           | Issue description                                            | Issue source |
| ----- | --------- | ------------------------------------------------ | ------------------------------------------------------------ | ------------ |
| 1     | important | Fix the Dolby module security boot flag judgment | report error when check secure boot flag in Dolby module     | 585202       |
| 2     | important | check ctx panicked before run user TA            | When multiple User TAs are running, one TA experiencing Panic has a low probability of causing TEE OS to crash |              |
| 3     | moderate  | Fix the printing position of TEE OS in Pstore    | TEE OS printing mixed with U-Boot printing                   |              |
...
| Date       | File                               | Build commit | Severity  |
| ---------- | :--------------------------------- | ------------ | --------- |
| 2025-11-03 | rk3576_scp_{uart4,uart8}_v1.14.bin | 60f21109     | important |

### New

1. Support pll automatic calculation.
2. Support DCLK frequency setting to automatically set the frequency of the parent clock PLL, while DTS needs to bind the parent clock.
...
| Date       | File                          | Build commit | Severity  |
| ---------- | :-----------------------------| -----------  | --------- |
| 2025-09-25 | rk3576_rsc_tbl_v1.01.bin      | a839982e3    | important |

### Fixed

| Index | Severity  | Update                | Issue description                    | Issue source |
| ----- | --------- | --------------------- | ------------------------------------ | ------------ |
| 1     | important | Fix remoteproc        | remoteproc is not working properly   | software version rules have changed |
...
| Date       | File                  | Build commit | Severity  |
| ---------- | :-------------------- | ------------ | --------- |
| 2025-09-23 | rk3576_bl31_v1.22.elf | f6b23103b | important |

### New

1. Improve the stability of ultra sleep.
2. Support VAD wake-up.
------
...
| Date       | File                  | Build commit | Severity  |
| ---------- | :-------------------- | ------------ | --------- |
| 2025-07-01 | rk3576_bl32_v1.07.bin | 3864e29ae    | important |

### New

1. Added support for Dolby library interfaces.
2. Support deriving CMAC KDF keys from OEM OTP KEY.
...
| Date       | File                                                         | Build commit | Severity  |
| ---------- | :----------------------------------------------------------- | ------------ | --------- |
| 2025-06-26 | rk3576_ddr_lp4_2112MHz_lp5_2736MHz{_ultra,_eyescan}_v1.10.bin | 9071d8ccd4   | important |

### Warn

1. The bl31 should be updated to v1.20 or above.

### New

1. Add LPDDR5 master die check.
2. Add LPDDR4(X) RZQI check.
...
| 2     | important | ultra suspend jump address alignment with bl31 | -                                                            | -              |
| 3     | important | Optimize SI of LPDDR4(X) CA                    | CA signal timing margins may be insufficient for some high-density LPDDR4(X) | 551274, 556845 |
| 4     | moderate  | Fix trefi and tras_max calculations            | -                                                            | -              |
